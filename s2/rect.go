...
// GetCentroid returns the centroid of the given Rect
func (r Rect) GetCentroid() Point {
	...
	// of the z-interval spanned by the S2LatLngRect.
	//
	...
	// z-plane, the S2LatLngRect is a circular arc. The centroid of this arc
